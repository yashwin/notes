...
2) 3 values - **margin: 1px 2px 3px;**
  ...
  Here *margin-top* is 1px, *margin-right* & *margin-left* are 2px each & *margin-bottom* is 3px

3) 2 values - **margin: 1px 2px;**

  Here *margin-top* & *margin-bottom* are 1px each, *margin-right* & *margin-left* are 2px each
